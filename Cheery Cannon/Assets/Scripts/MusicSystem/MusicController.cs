...
namespace MusicSystem
{
    public class MusicController : MonoBehaviour
    {
        ...
        public void LoadIcons(Image musicIcon, Image soundIcon)
        {
            ChangeVolume(_musicIsOn, musicMixerName, musicIcon,
                _musicOnImage, _musicOffImage);
            ChangeVolume(_effectsIsOn, effectsMixerName, soundIcon,
